...
#Date: 5 June 2015
#purpouse: This file is for instantiating all the movie objects and then call display_page.py to render the movies in an html page
...
# Call another python script to render the movies with its information on an html page
